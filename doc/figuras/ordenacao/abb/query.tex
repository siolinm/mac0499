\begin{figure}
    ...
    \begin{tikzpicture}[thick]
        ...
        \draw[thick] (3) -- (7);
        \draw[very thick] (6) --  node[above, sloped] {$i = 1$} (12);
        \draw[thick] (6) -- (13);
        % \draw[thick] (7) -- (14);
        % \draw[thick] (7) -- (15);
    \end{tikzpicture}
    \caption[Exemplo de busca pelo $i$-ésimo]{Exemplo busca pelo
    $7^\circ$ elemento na árvore da Figura \ref{fig:abb:query}.}
