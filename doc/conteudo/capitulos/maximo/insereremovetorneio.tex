...
%$\textsc{updatePQ}(Q, e, t)$ e a rotina \Call{expire}{$e,e'$}, que calcula a validade do
%certificado entre os elementos $e$ e $e'$; se $e'$ é \null retorna $+\infty$.
%
%\input{conteudo/capitulos/maximo/algoritmos/torneio/insertdelete/update}
%
%No trecho das linhas $5 - 11$ do Algoritmo~\ref{torneioi:evento}, o resultado da partida entre o
...
\Call{compare}{$i, j$} retorna se o valor de $i$ é maior que o valor de $j$.
