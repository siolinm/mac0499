\begin{figure}[H]
    ...
    \begin{tikzpicture}[thick, scale=0.8]
        ...
        % \draw[cert] (7) -- (15);
    \end{tikzpicture}
    \caption[Torneio após remoção de elemento]{Torneio da Figura
    \ref{fig:torneioi:cert} após a remoção do elemento com \id~$3$.
    ...
    que o elemento $3$ ocupava. Todas as partidas até o topo foram
    recalculadas com os devidos certificados atualizados. As setas
    azuis pontilhadas representam os certificados atualizados.}
