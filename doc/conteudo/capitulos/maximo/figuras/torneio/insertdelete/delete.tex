\begin{figure}
    ...
    \begin{tikzpicture}[thick, scale=0.8]
        ...
        % \draw[cert] (7) -- (15);
    \end{tikzpicture}
    \caption[Torneio após remoção de elemento]{A figura mostra o
    torneio da figura \ref{fig:torneioi:cert} após a remoção do
    elemento com \id~$3$. O elemento $8$ que era o perdedor da
    partida entre os elementos que ocupam a última posição foi usado
    para substituir a posição que o elemento $3$ ocupava. Todas
    partidas até o topo foram recalculadas com os devidos
    certificados atualizados. As setas azuis pontilhadas representam
