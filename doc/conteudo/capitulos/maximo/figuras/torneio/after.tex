\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Exemplo de tratamento de certificado no torneio]{Após
    \cert[$8$] ter expirado, o elemento $8$ passou a vencer o
    elemento $1$ e \torneio[$4$] foi atualizado, o elemento $8$
        também venceu os elementos $3$ e $4$ e \torneio[$2$] e
        \torneio[$1$] foram atualizados. Os certificados \cert[$1$],
        \cert[$3$] e \cert[$4$], indicados pelas setas azuis tracejadas, também
        foram atualizados.}
    \label{fig:torneio:after}
\end{figure}