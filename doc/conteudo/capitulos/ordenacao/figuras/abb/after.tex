\begin{figure}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption[Exemplo de atualização de certificados da árvore binária de busca]{Em $\now = 1$, o
    elemento $1$ e o elemento $2$ foram trocados e os certificados do elemento $1$,
        do elemento $2$ e do elemento $4$ foram atualizados.}
    \label{fig:abb:after}
\end{figure}