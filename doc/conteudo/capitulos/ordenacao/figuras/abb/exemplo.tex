\begin{figure}[H]
    ...
    \begin{tabular}{|c|c|}
        ...
        \hline
    \end{tabular}
    \caption[Exemplo de árvore binária de busca com lista duplamente ligada]{Exemplo de árvore
    em que a ordem dos elementos, do menor para o maior no instante $\now = 0$, é $5 - 3 - 2 -
    1 - 4 - 6$.
    Os apontadores para o elemento anterior são representados pelas setas vermelhas tracejadas
    e os apontadores para o elemento posterior são representados pelas setas azuis pontilhadas
    .}\label{fig:abb:exemplo}
\end{figure}