\begin{figure}[H]
    ...
    \begin{tikzpicture}[thick]
        ...
        \draw[->] (3) -- (4);
    \end{tikzpicture}
    \caption[Exemplo após atualização de certificados da lista ordenada]{Após a mudança de
    velocidade, no instante $t = 2.1$, do elemento 3, que se encontra em \sorted[2], \cert[1] e
