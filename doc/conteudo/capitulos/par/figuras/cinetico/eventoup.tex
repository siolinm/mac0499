\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Exemplo de evento \textsc{up}]{Da esquerda para a direita, o caso em que $p$ está em
    $\Hits_{low}(q)$, ou seja, $q$ está entrando em $\Dom(p)$.
